...
"#;
    ...
    assert!(user_file.contains(".condition(dinoco_engine::Expression::Column(\"user_A_id\".to_string())"));
    ...
    assert!(user_file.contains(".condition(dinoco_engine::Expression::Column(\"user_B_id\".to_string())"));
    ...
    assert!(post_file.contains(".condition(dinoco_engine::Expression::Column(\"post_id\".to_string())"));
