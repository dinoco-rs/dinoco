...
const CRATE_VERSION: &str = "2.0.3";
const PREVIOUS_CRATE_VERSION: &str = "2.0.2";
...
const DOCS_VERSION: &str = "2.0.3";
const PREVIOUS_DOCS_VERSION: &str = "2.0.2";
...
fn documentation_uses_the_current_version_directories() {
    ...
    assert!(versions.contains("import v2_0_3 from './versions/v2.0.3';"));
    assert!(versions.contains("const versionsData: DocsVersionData[] = [v2_0_3"));
