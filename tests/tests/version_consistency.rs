...
const PREVIOUS_VERSION: &str = "1.2.4";
...
fn documentation_uses_the_current_version_directories() {
    ...
    assert!(versions.contains("import v1_2_5 from './versions/v1.2.5';"));
    assert!(versions.contains("const versionsData: DocsVersionData[] = [v1_2_5"));
