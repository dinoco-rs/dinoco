...
const PREVIOUS_VERSION: &str = "1.2.0";
...
fn documentation_uses_the_current_version_directories() {
    ...
    assert!(versions.contains("import v1_2_1 from './versions/v1.2.1';"));
    assert!(versions.contains("const versionsData: DocsVersionData[] = [v1_2_1"));
