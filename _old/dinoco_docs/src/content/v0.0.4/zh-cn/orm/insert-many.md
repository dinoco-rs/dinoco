...
- [**Derives**](/v0.0.4/core/derives): entenda como montar payloads com `Extend` e `#[insertable]`.
- [**`insert_into::<M>()`**](/v0.0.4/orm/insert-into): inserção única.
- [**`update::<M>()`**](/v0.0.4/orm/update): atualização com filtro.
