...
async fn main() -> dinoco::DinocoResult<()> {
    ...
    insert_into::<User>()
        ...
        .with_relation(Post { id: 0, title: "My first post".to_string(), published: true, authorId: None })
        .execute(&client)
        .await?;
...
-   [**Dinoco schema**](/v0.0.1/orm/introduction-dinoco): Better understand Dinoco's structure and proposal.
-   [**Dinoco client**](/v0.0.1/orm/first-steps): Review this complete client flow.
