...
- `.values(item)` ou `.values(&item)`: informa os novos valores do registro.
...
- [**`update_many::<M>()`**](/v0.0.6/orm/update-many): atualização em lote.
- [**`find_and_update::<M>()`**](/v0.0.6/orm/find-and-update): update atômico com retorno.
