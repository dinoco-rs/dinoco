...
- [**Derives**](/v0.0.5/core/derives): entenda quando usar `Rowable`, `Extend` e `#[insertable]`.
- [**`insert_many::<M>()`**](/v0.0.5/orm/insert-many): inserção em lote.
- [**`update::<M>()`**](/v0.0.5/orm/update): atualização de registros.
