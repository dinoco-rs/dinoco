...
- [**Derives**](/v0.0.8/core/derives): veja os derives e atributos usados junto dessas traits.
- [**Relações**](/v0.0.8/orm/relations): veja como isso se conecta ao sistema de relações.
