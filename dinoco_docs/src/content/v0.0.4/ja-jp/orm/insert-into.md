...
Veja mais sobre workers em [**`queues`**](/v0.0.4/orm/queues).

## Próximos passos

- [**Derives**](/v0.0.4/core/derives): entenda quando usar `Rowable`, `Extend` e `#[insertable]`.
- [**`insert_many::<M>()`**](/v0.0.4/orm/insert-many): inserção em lote.
- [**`update::<M>()`**](/v0.0.4/orm/update): atualização de registros.
