...
**Dinoco** offers native support for **PostgreSQL**, **MySQL**, and **SQLite** databases.
...
The configuration is done within the `config` block in your schema file.
...
For external databases, insert the corresponding connection string:
