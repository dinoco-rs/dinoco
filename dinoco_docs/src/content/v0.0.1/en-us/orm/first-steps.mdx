...
To create the Dinoco environment, run the following command:

```bash
dinoco init
```

After choosing the database and all necessary configurations, the dinoco folder will be created in the root of your project.
