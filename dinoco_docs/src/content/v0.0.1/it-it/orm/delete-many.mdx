...
- `.cond(...)`: aggiunge filtri per l'eliminazione in blocco.
- `.execute(&client)`: esegue l'eliminazione dei record corrispondenti.
...
- [**`delete::<M>()`**](/v0.0.1/orm/delete): eliminazione puntuale con filtro esplicito.
- [**`find_many::<M>()`**](/v0.0.1/orm/find-many): elencare prima dell'eliminazione in blocco.
