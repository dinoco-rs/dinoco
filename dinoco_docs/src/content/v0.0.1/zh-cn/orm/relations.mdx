...
let created_user = insert_into::<User>()
	...
	.with_relation(Profile {
		...
		bio: Some("Engenheira de software".to_string()), // 软件工程师
		userId: String::new(),
	})
	.execute(&client)
	.await?;
...
let posts = vec![
	Post {
		id: "post-1".to_string(),
		title: "Primeiro post".to_string(), // 第一篇文章
		content: "Conteudo do primeiro post".to_string(), // 第一篇文章的内容
		authorId: "user-1".to_string(),
	},
	Post {
		id: "post-2".to_string(),
		title: "Segundo post".to_string(), // 第二篇文章
		content: "Conteudo do segundo post".to_string(), // 第二篇文章的内容
		authorId: "user-1".to_string(),
	},
];
...
let comments_per_post = vec![
	vec![
		...
		Comment {
			...
			text: "Gostei do exemplo".to_string(), // 我喜欢这个例子
			parentId: None,
			postId: String::new(),
	...
	vec![
		Comment {
			...
			text: "Quero mais detalhes".to_string(), // 我想要更多细节
			parentId: None,
			postId: String::new(),
			authorId: "user-2".to_string(),
		},
...
insert_many::<Post>()
	.values(vec![
		Post {
			...
			title: "Rust e Dinoco".to_string(), // Rust 和 Dinoco
			content: "Post sobre produtividade".to_string(), // 关于生产力的文章
			authorId: "user-1".to_string(),
		},
		Post {
			id: "post-11".to_string(),
			title: "Relações avançadas".to_string(), // 高级关系
			content: "Post sobre includes e relacoes".to_string(), // 关于 includes 和关系的帖子
			authorId: "user-1".to_string(),
		},
	])
