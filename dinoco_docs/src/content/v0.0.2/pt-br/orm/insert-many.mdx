...
- Inserir vários registros simples em lote.
- Inserir vários registros com relações novas aninhadas.
- Inserir vários registros com conexões para itens já existentes.
