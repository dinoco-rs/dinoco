...
Use an `Extend` payload with `#[insertable]` to create the parent and also create the related record in the same flow.
...
- [**`update::<M>()`**](/v0.0.2/orm/update): updating records.
