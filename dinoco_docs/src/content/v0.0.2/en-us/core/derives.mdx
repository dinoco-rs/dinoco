...
Overview of the core derives and attributes used in Dinoco.

---

## What are derives in Dinoco

Dinoco derives help link your Rust structs to ORM behavior without needing to write all the implementation manually.
...
This derive serializes the row returned by the adapter into the Rust struct.
