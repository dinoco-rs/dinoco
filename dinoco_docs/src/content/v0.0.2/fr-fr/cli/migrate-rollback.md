...
Elle est utile lorsque vous avez besoin d'annuler la modification la plus récente dans la base de données.
...
[NOME] : Nom de la migration (pour revenir à une migration spécifique) (Optionnel)
