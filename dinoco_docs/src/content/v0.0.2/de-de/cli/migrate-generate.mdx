...
Er vergleicht den aktuellen Zustand des Schemas mit dem bekannten Verlauf und erstellt die notwendigen Artefakte zur Weiterentwicklung der Datenbank.
...
- Die Migration vor der Anwendung überprüfen möchten
- Die Änderungen in der Versionskontrolle überprüfen möchten
- Die Generierung und Ausführung in verschiedene Schritte aufteilen möchten
