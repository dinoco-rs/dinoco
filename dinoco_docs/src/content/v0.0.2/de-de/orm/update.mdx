...
- `.connect(...)`: erstellt unterstützte Schreibbeziehungen.
- `.disconnect(...)`: entfernt unterstützte Schreibbeziehungen.
...
- `update().returning()` unterstützt keine Schreibbeziehungen mit `.connect(...)` oder `.disconnect(...)`.
...
Wird verwendet, um unterstützte Schreibbeziehungen zu verbinden, normalerweise Many-to-Many.
