...
| Attribut        | Verwendung                       |
| :-------------- | :------------------------------- |
| `@id`           | Definiert den Hauptidentifikator |
...
Zusätzlich zu den Attributen in einzelnen Feldern unterstützt Dinoco auch Dekoratoren, die auf den gesamten Modellblock angewendet werden.

| Dekorator             | Verwendung                               |
| :-------------------- | :--------------------------------------- |
...
Wenn Sie atomare Updates für ein einzelnes Feld wünschen, ist der `find_and_update`-Workflow oft noch direkter:
