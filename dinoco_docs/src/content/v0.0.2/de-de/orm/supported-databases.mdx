...
**Dinoco** bietet native Unterstützung für die Datenbanken **PostgreSQL**, **MySQL** und **SQLite**. Wir arbeiten daran, diese Unterstützung bald auf neue Datenbanken auszuweiten!
