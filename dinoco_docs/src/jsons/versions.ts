import v0_1_1 from './versions/v0.1.1';

export type DocsLocale = 'pt-br';
export const SUPPORTED_LOCALES: DocsLocale[] = ['pt-br'];
...
const versionsData: DocsVersionData[] = [v0_1_1 as DocsVersionData];
