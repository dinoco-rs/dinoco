...
export const metadata: Metadata = {
	description: 'Dinoco v1.1.10 documentation for schemas, migrations, typed Rust queries, relations, and database adapters.',
	title: {
		default: 'Dinoco v1.1.10 documentation',
		template: '%s | Dinoco',
	},
};
