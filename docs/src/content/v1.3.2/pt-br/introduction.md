...
## A superfície da v1.3.2

A v1.3.2 mantém um fluxo público pequeno e previsível. A CLI inicializa o projeto, gera e executa migrations e regenera models. O runtime expõe builders como `find_many`, `insert_into`, `update_many` e `delete`.
