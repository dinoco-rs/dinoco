...
- [Find first](/v1.3.2/orm/find-first)
- [Find many](/v1.3.2/orm/find-many)
- [Find and update](/v1.3.2/orm/find-and-update)
- [Count](/v1.3.2/orm/count)
...
- [Filtros](/v1.3.2/orm/filters) para operadores simples;
- [Where complex](/v1.3.2/orm/where-complex) para `AND`, `OR` e `NOT`;
- [Busca full-text](/v1.3.2/orm/full-text-search);
- [Select](/v1.3.2/orm/select);
- [Includes](/v1.3.2/orm/includes);
- [Transactions](/v1.3.2/orm/transactions).
