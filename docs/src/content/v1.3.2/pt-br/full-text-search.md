...
A busca seleciona a row que será atualizada e retornada. Veja [Find and update](/v1.3.2/orm/find-and-update).
...
- Ranking, idioma configurável, frases e tokenizers customizados não fazem parte da v1.3.2.
