...
Install the v1.0.7 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.0.7
cargo add dinoco@1.0.7 dinoco_engine@1.0.7 anyhow
