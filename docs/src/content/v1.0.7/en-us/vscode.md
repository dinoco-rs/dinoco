...
The v1.0.7 language server provides:
...
Remote and virtual workspaces are not supported in v1.0.7 because generated files, local commands, and database prompts require a real workspace filesystem.
