...
No schema, UUID continua sendo declarado como `String` e Snowflake como `Integer`. O codegen da v1.0.7 acompanha a chave referenciada e preserva o wrapper Rust:
