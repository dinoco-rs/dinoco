...
- a pivô implícita `TagTask` mistura corretamente `tag_id: Uuid` e `task_id: Snowflake`.
...
Conecte `Task` e `Tag` pela entity `TagTask` gerada:
...
7. Use a entity pivô gerada para N:N.
