...
- missing files are compilation errors;
- circular imports are supported: each file is parsed and consolidated only once, including when models in different files reference one another;
