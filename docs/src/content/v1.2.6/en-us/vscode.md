...
The v1.2.6 language server provides:
...
Remote and virtual workspaces are not supported in v1.2.6 because generated files, local commands, and database prompts require a real workspace filesystem.
