...
> [!NOTE]
> Esta página descreve o motor `automatic`, o padrão. Para escrever migrations você mesmo em Rust — backfills de dados, DDL específico do banco, um `down` revisado — configure `migration_engine = "manual"`; veja [Migrations manuais](/pt-br/docs/orm/guide/manual-migrations).
