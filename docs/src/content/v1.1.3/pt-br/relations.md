...
No schema, UUID continua sendo declarado como `String` e Snowflake como `Integer`. O codegen da v1.1.3 acompanha a chave referenciada e preserva o wrapper Rust:
