...
Para grupos explícitos, use [Where complex](/v1.1.0/orm/where-complex). Fields `@fulltext` também funcionam:
...
Consulte [Select](/v1.1.0/orm/select) e [Includes](/v1.1.0/orm/includes).
