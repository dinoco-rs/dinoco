...
Mudanças de nome, colunas, ordem ou tipo geram os passos de drop/create correspondentes. Consulte [Índices e constraints](/v1.2.1/guide/indexes) para as regras do schema.
