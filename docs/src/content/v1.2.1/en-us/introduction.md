...
Version 1.2.1 intentionally has a compact public workflow. The CLI exposes `init`, migration generation and execution, and model generation. The runtime exposes builders such as `find_many`, `insert_into`, `update_many`, and `delete`.
