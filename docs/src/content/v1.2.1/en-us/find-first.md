...
Use [Where complex](/v1.2.1/orm/where-complex) for explicit groups. `@fulltext` fields work here too:
...
See [Select](/v1.2.1/orm/select) and [Includes](/v1.2.1/orm/includes).
