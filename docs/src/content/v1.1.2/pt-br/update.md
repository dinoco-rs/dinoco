...
Consulte [Many-to-many implícito](/v1.1.2/guide/relations#many-to-many-implícito) para a API completa pelos endpoints e as regras da tabela pivô.

Para atualizar exatamente uma row e receber a entity completa sem `.returning()`, consulte a página dedicada [Find and update](/v1.1.2/orm/find-and-update).
