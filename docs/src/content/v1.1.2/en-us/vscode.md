...
The v1.1.2 language server provides:
...
Remote and virtual workspaces are not supported in v1.1.2 because generated files, local commands, and database prompts require a real workspace filesystem.
