...
Install the v1.1.2 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.1.2
cargo add dinoco@1.1.2 dinoco_engine@1.1.2 anyhow
