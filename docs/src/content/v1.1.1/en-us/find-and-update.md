...
When `where_complex` is present, every `where_` on the builder is ignored, before or after it. See [Where complex](/v1.1.1/orm/where-complex).
...
- It is unavailable in MySQL transactions in v1.1.1.
