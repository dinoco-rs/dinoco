...
Install the v1.1.1 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.1.1
cargo add dinoco@1.1.1 dinoco_engine@1.1.1 anyhow
