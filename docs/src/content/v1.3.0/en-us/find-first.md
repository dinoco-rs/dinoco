...
Use [Where complex](/v1.3.0/orm/where-complex) for explicit groups. `@fulltext` fields work here too:
...
See [Select](/v1.3.0/orm/select) and [Includes](/v1.3.0/orm/includes).
