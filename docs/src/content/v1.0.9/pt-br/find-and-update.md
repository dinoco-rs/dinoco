...
Quando `where_complex` é usado, todos os `where_` do builder são ignorados, antes ou depois dele. Veja [Where complex](/v1.0.9/orm/where-complex).
...
- Dentro de transactions, não está disponível no MySQL v1.0.9.
