...
The v1.0.9 language server provides:
...
Remote and virtual workspaces are not supported in v1.0.9 because generated files, local commands, and database prompts require a real workspace filesystem.
