...
Use [Where complex](/v1.0.9/orm/where-complex) for explicit groups. `@fulltext` fields work here too:
...
See [Select](/v1.0.9/orm/select) and [Includes](/v1.0.9/orm/includes).
