...
Install the v1.0.9 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.0.9
cargo add dinoco@1.0.9 dinoco_engine@1.0.9 anyhow
