...
Use [Where complex](/v1.2.4/orm/where-complex) for explicit groups. `@fulltext` fields work here too:
...
See [Select](/v1.2.4/orm/select) and [Includes](/v1.2.4/orm/includes).
