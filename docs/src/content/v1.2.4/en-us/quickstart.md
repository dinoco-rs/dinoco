...
Install the v1.2.4 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.2.4
cargo add dinoco@1.2.4 dinoco_engine@1.2.4 anyhow
