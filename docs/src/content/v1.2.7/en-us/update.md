...
To update exactly one row and receive the complete entity without `.returning()`, see the dedicated [Find and update](/v1.2.7/orm/find-and-update) page.
...
See [Implicit many-to-many](/v1.2.7/guide/relations#implicit-many-to-many) for the complete endpoint API and pivot-table semantics.
