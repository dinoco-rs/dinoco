...
Para grupos explícitos, use [Where complex](/v1.0.8/orm/where-complex). Fields `@fulltext` também funcionam:
...
Consulte [Select](/v1.0.8/orm/select) e [Includes](/v1.0.8/orm/includes).
