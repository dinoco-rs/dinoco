...
- [Find first](/v1.0.8/orm/find-first)
- [Find many](/v1.0.8/orm/find-many)
- [Find and update](/v1.0.8/orm/find-and-update)
- [Count](/v1.0.8/orm/count)
...
- [Filtros](/v1.0.8/orm/filters) para operadores simples;
- [Where complex](/v1.0.8/orm/where-complex) para `AND`, `OR` e `NOT`;
- [Busca full-text](/v1.0.8/orm/full-text-search);
- [Select](/v1.0.8/orm/select);
- [Includes](/v1.0.8/orm/includes);
- [Transactions](/v1.0.8/orm/transactions).
