...
## A superfície da v1.0.8

A v1.0.8 mantém um fluxo público pequeno e previsível. A CLI inicializa o projeto, gera e executa migrations e regenera models. O runtime expõe builders como `find_many`, `insert_into`, `update_many` e `delete`.
