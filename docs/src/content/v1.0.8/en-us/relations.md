...
UUID keys are declared as `String` in the schema and Snowflake keys as `Integer`. Dinoco v1.0.8 follows the referenced field and preserves its generated Rust wrapper:
