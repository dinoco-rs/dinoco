...
When `where_complex` is present, every `where_` on the builder is ignored, before or after it. See [Where complex](/v1.0.8/orm/where-complex).
...
- It is unavailable in MySQL transactions in v1.0.8.
