...
Install the v1.0.8 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.0.8
cargo add dinoco@1.0.8 dinoco_engine@1.0.8 anyhow
