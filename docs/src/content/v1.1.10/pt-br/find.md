...
- [Find first](/v1.1.10/orm/find-first)
- [Find many](/v1.1.10/orm/find-many)
- [Find and update](/v1.1.10/orm/find-and-update)
- [Count](/v1.1.10/orm/count)
...
- `order_by(...)`;
- `read_in_primary()`;
- execução dentro de `Transaction`.
...
- [Filtros](/v1.1.10/orm/filters) para operadores simples;
- [Where complex](/v1.1.10/orm/where-complex) para `AND`, `OR` e `NOT`;
- [Busca full-text](/v1.1.10/orm/full-text-search);
- [Select](/v1.1.10/orm/select);
- [Includes](/v1.1.10/orm/includes);
- [Transactions](/v1.1.10/orm/transactions).
