...
Use [Where complex](/v1.2.3/orm/where-complex) for explicit groups. `@fulltext` fields work here too:
...
See [Select](/v1.2.3/orm/select) and [Includes](/v1.2.3/orm/includes).
