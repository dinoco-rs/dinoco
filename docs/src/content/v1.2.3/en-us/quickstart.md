...
Install the v1.2.3 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.2.3
cargo add dinoco@1.2.3 dinoco_engine@1.2.3 anyhow
