...
A busca seleciona a row que será atualizada e retornada. Veja [Find and update](/v1.2.5/orm/find-and-update).
...
- Ranking, idioma configurável, frases e tokenizers customizados não fazem parte da v1.2.5.
