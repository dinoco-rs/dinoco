...
Para grupos explícitos, use [Where complex](/v1.2.5/orm/where-complex). Fields `@fulltext` também funcionam:
...
Consulte [Select](/v1.2.5/orm/select) e [Includes](/v1.2.5/orm/includes).
