...
- completion para config, scalars, models, enums, defaults, relation keys e ações referenciais;
- hover com documentação;
- go to definition, references e rename seguro;
...
O formatter é idempotente: formatar de novo não deve alterar o resultado.
