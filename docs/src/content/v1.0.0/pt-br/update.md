...
Uma única operação atualiza e retorna a entity completa, sem `.returning()`. Ausência de row é erro; connect e disconnect não são suportados nesse builder.
