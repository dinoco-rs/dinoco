...
> [!NOTE]
> This page describes the default `automatic` engine. To write migrations yourself in Rust — data backfills, database-specific DDL, a reviewed `down` — set `migration_engine = "manual"`; see [Manual migrations](/en-us/docs/orm/guide/manual-migrations).
