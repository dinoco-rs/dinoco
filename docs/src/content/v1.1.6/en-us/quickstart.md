...
Install the v1.1.6 CLI and add the runtime dependencies to your project:

```bash
cargo install dinoco --version 1.1.6
cargo add dinoco@1.1.6 dinoco_engine@1.1.6 anyhow
