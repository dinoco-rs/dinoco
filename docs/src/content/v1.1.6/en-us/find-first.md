...
Use [Where complex](/v1.1.6/orm/where-complex) for explicit groups. `@fulltext` fields work here too:
...
See [Select](/v1.1.6/orm/select) and [Includes](/v1.1.6/orm/includes).
