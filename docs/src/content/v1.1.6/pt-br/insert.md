...
Consulte [Many-to-many implícito](/v1.1.6/guide/relations#many-to-many-implícito) para entender os fields gerados, o comportamento da pivô, includes nos dois sentidos, counts, connect/disconnect e a migração de código existente.
