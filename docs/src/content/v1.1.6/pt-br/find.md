...
- [Find first](/v1.1.6/orm/find-first)
- [Find many](/v1.1.6/orm/find-many)
- [Find and update](/v1.1.6/orm/find-and-update)
- [Count](/v1.1.6/orm/count)
...
- [Filtros](/v1.1.6/orm/filters) para operadores simples;
- [Where complex](/v1.1.6/orm/where-complex) para `AND`, `OR` e `NOT`;
- [Busca full-text](/v1.1.6/orm/full-text-search);
- [Select](/v1.1.6/orm/select);
- [Includes](/v1.1.6/orm/includes);
- [Transactions](/v1.1.6/orm/transactions).
